...
$ns duplex-link $n6 $n7 0.3Mb 30ms DropTail
$ns duplex-link $n7 $n3 0.3Mb 30ms DropTail
$ns duplex-link $n3 $n7 0.3Mb 30ms DropTail
$ns duplex-link $n7 $n6 0.3Mb 30ms DropTail
$ns duplex-link $n6 $n2 0.3Mb 30ms DropTail
$ns duplex-link $n2 $n8 0.3Mb 100ms DropTail
$ns duplex-link $n8 $n3 0.3Mb 100ms DropTail
$ns duplex-link $n3 $n8 0.3Mb 100ms DropTail
$ns duplex-link $n8 $n2 0.3Mb 100ms DropTail
...
#$ns duplex-link-op $n3 $n7 orient left
